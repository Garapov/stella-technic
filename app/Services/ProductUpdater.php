...
class ProductUpdater
{
    public $params = [
        ...
        ['code' => 'kol_radius_gabaritnyh_razmerov_tormoza', 'name' => 'Радиус габаритных размеров тормоза, мм'],
        ...
        ['code' => 'kol_diametr_stupicy', 'name' => 'Диаметр ступицы, мм'],
        ['code' => 'kol_dlina_stupicy', 'name' => 'Ширина ступицы, мм'],
        ['code' => 'kol_diametr_kolesa', 'name' => 'Диаметр колеса, мм'],
        ['code' => 'gruz_t_kg', 'name' => 'Грузоподъемность, кг'],
        ['code' => 'kol_shirina_kolesa_mm', 'name' => 'Ширина колеса, мм'],
        ['code' => 'kol_vysota_kolesa_mm', 'name' => 'Высота колеса, мм'],
        ['code' => 'kol_platforma', 'name' => 'Габариты площадки, мм'],
        ['code' => 'kol_mezhosevoe_rasstoyanie_krepezhnyh_otverstij', 'name' => 'Межосевое расстояние крепежных отверстий, мм'],
        ['code' => 'kol_smeshchenie_osej', 'name' => 'Смещение осей, мм'],
        ['code' => 'diametr_gnezda_podshipnikov', 'name' => 'Диаметр гнезда подшипника, мм'],
        ['code' => 'glubina_gnezda_podshipnikov', 'name' => 'Глубина гнезда подшипника, мм'],
        ['code' => 'fastening', 'name' => 'Крепление, '],
        ['code' => 'kol_ves_kolesa_kg', 'name' => 'Вес, кг'],
        ['code' => 'ves_kg', 'name' => 'Вес, кг'],
        ['code' => 'kol_diametr_paneli', 'name' => 'Диаметр площадки, мм'],
        ['code' => 'diametr_krepezhnogo_otverstiya', 'name' => 'Диаметр крепежного отверстия, мм'],
        ...
        ['code' => 'maks_diametr_osi_mm', 'name' => 'Максимальный диаметр ступицы, мм'],
        ['code' => 'naruzhnyj_diametr_stupicy_mm', 'name' => 'Наружный диаметр ступицы, мм'],
        ['code' => 'kol_material_kronshtejna', 'name' => 'Материал кронштейна'],
        ['code' => 'bracket_material', 'name' => 'Материал кронштейна'],
        ['code' => 'dlina_rezbovogo_sterzhnya', 'name' => 'Длина резьбового стержня, мм'],
        ['code' => 'diametr_rezbovogo_sterzhnya', 'name' => 'Диаметр резьбового стержня, мм'],
        ['code' => 'kol_diametr_otverstij_paneli', 'name' => 'Диаметр отверстий панели, мм'],
    ];
