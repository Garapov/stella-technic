    ...
    <div class="grid items-start grid-cols-1 lg:grid-cols-2 gap-8 max-lg:gap-12 max-sm:gap-8">
        ...
        <div class="w-full lg:sticky top-10">
            ...
            <div class="flex flex-col gap-2">
                <div class="border border-blue-500 p-2 rounded-lg">
                    <div class="text-lg text-bold mb-2">
                        Кликнуть можно на любой параметр, но будет спрыгивать если такой связи не существует
                    </div>
                    <div class="parametrs">
                ...
                <div class="border border-blue-500 p-2 rounded-lg">
                    <div class="text-lg text-bold mb-2">
                        Кликнуть можно только на параметры которые существуют, остальные недоступны
                    </div>
                    <div class="parametrs">
                        @foreach($groupedParams as $paramGroup)
                            <div class="mb-6">
                                        ...
                                        @if($paramGroup['name'] === 'Цвет')
                                            <a href="{{ route('client.product_detail', $variation->product->variants->where('id', $value['variant_id'])->first()->slug) }}" wire:navigate
                                                @class([
                                                    ...
                                                    'border-blue-600' => $value['is_current'],
                                                    'border-slate-300 hover:border-blue-600' => !$value['is_current'] && $value['is_available'],
                                                    'border-slate-200 opacity-30 pointer-events-none' => !$value['is_available']
                                                ]) 
                ...
                <div class="border border-blue-500 p-2 rounded-lg">
                    <div class="text-lg text-bold mb-2">
                    Отображаются только параметры которые доступны
                    </div>
                    <div class="parametrs">
                        @foreach($groupedParams as $paramGroup)
                            <div class="mb-6">
