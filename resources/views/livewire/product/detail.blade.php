<div class="lg:grid lg:grid-cols-2 lg:gap-8 xl:gap-16" x-data="{
    ...
    <div class="mt-6 sm:mt-8 lg:mt-0">
        ...
        <div class="mt-6 sm:gap-4 sm:items-center sm:flex sm:mt-8 mb-4">
            ...
            <button title=""
                class="text-white mt-4 sm:mt-0 bg-blue-500 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-500 dark:hover:bg-blue-500 focus:outline-none dark:focus:ring-blue-800 flex items-center justify-center"
