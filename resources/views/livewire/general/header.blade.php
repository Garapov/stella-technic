            ...
            <div class="flex gap-4 items-stretch">
                ...
                @auth
                    <div class="relative">
                        ...
                        @if ($isUserMenuOpened)
                            <div class="absolute top-[calc(100%+10px)] w-full z-10 bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
                                <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDividerButton">
                                    <li>
                                        <a href="{{ route('dashboard.index') }}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white" wire:navigate>Dashboard</a>
                                    </li>
                                </ul>
                                <div class="py-2">
                    ...
                    <button role="menuitem"
                        ...
                        <div class="flex items-center justify-center rounded-lg !bg-blue-gray-50 p-2 ">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                                aria-hidden="true" stroke-width="2" class="h-6 w-6 text-gray-900">
                                <path
