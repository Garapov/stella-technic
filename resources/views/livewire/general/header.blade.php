        ...
        <div class="flex flex-wrap justify-between items-center mx-auto container">
            <div class="hidden justify-between items-center w-full lg:flex lg:w-auto">
                <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                    ...
                    <li>
                        <a href="#"
                            class="block py-2 pr-4 pl-3 text-sm text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">Ремонт и сервис</a>
                    </li>
                    <li>
                        <a href="#"
        ...
        <div class="flex flex-wrap gap-8 justify-between items-center mx-auto container">
			...
			<div class="flex gap-4 items-stretch">
				<div class="flex flex-col items-end">
					<a href="tel:88005514694" class="text-lg font-bold text-right text-gray-900 dark:text-white">8 800 551-46-94</a>
					<div class="text-xs text-blue-600">Заказать звонок</div>
				</div>
				<div class="border border-gray-900"></div>
				<div class="flex flex-col">
					<a href="tel:+74956611717" class="text-lg font-bold text-gray-900 dark:text-white">+7 (495) 661-17-17</a>
			...
			<div class="flex gap-2">
				<button type="button" class="relative inline-flex items-center p-3 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
					...
					<span class="sr-only">Notifications</span>
					  <div class="absolute inline-flex items-center justify-center w-6 h-6 text-xs font-bold text-white bg-red-500 border-2 border-gray-200 rounded-full -top-2 -end-2 dark:border-gray-700">20</div>
				</button>
