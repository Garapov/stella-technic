        ...
        <form wire:submit.prevent="subscribe" class="w-full max-w-md grow p-6 bg-white border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700">
            <div class="flex flex-col gap-1">
                <div data-element="fields" data-stacked="false" class="flex items-center w-full">
                    ...
                    <button type="submit" class="px-5 py-2.5 text-sm font-medium text-center text-white bg-blue-500 rounded-lg cursor-pointer hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:bg-blue-500 dark:hover:bg-blue-500 dark:focus:ring-blue-800 flex items-center gap-2">
                        Подписаться
