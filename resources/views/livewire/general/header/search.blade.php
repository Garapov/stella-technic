<form action="{{ route('client.search') }}" class="relative w-full" x-data="{ isOpen: false }">
    ...
    <button type="submit"
        class="absolute rounded-e-lg top-0 end-0 p-2.5 text-sm font-medium h-full text-white bg-blue-500 border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-500 dark:hover:bg-blue-500 dark:focus:ring-blue-800">
