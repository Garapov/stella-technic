<article class="glide__slide p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 flex flex-col justify-between">
    ...
    <div class="flex justify-between items-center">
        ...
        <a href="{{ route('client.articles.show', $article->slug) }}" class="inline-flex items-center font-medium text-blue-600 dark:text-blue-500 hover:underline" wire:navigate>
            Читать далее
