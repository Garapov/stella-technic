<div class="oglide__slide verflow-hidden bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
    <img class="lg:h-48 md:h-36 w-full object-cover object-center" src="{{$post->banner_url}}"
        alt="blog">
    ...
    <div class="p-6">
        ...
        <p class="leading-relaxed mb-3 dark:text-gray-200 text-gray-900 whitespace-normal">{{$post->excerpt}}</p>
        <div class="flex items-center flex-wrap ">
            <a href="{{ route('client.posts.show', ['category_slug' => $post->category->slug, 'slug' => $post->slug]) }}" class="text-indigo-500 inline-flex items-center md:mb-2 lg:mb-0" wire:navigate>Читать далее
