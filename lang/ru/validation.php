...
return [
    ...
    */
    ...
    'hex_color' => 'Поле :attribute должно содержать корректный цветовой HEX-код.',
    ...
    'password' => [
        ...
        'uncompromised' => 'Указанный :attribute появляется в утечке данных. Пожалуйста, выберите другой :attribute.',
    ],
